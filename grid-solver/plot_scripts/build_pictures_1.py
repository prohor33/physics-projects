...
while(quantity_of_files < end_quantity_of_files):
    ...
    output_file_name = "%s%s%i.png" % ("result " + str(gas_index) + "/temperature/",\
                                       start_file_name, quantity_of_files)
    plt.savefig(output_file_name)
    #plt.show()
...
##            pivot='mid', width=0.5/2.0, scale=1/5.0 )
    ...
    Q = quiver( X, Y, U, V, clim=(min_mod_gas_velocity, max_mod_gas_velocity), units='x',
            pivot='mid', width=0.25/2.0, scale=1.0/35.0 )    
...
##            pivot='mid', width=0.5/2.0, scale=1/5.0 )
    ...
    Q = quiver( X, Y, U, V, clim=(min_mod_gas_velocity, max_mod_gas_velocity), units='x',
            pivot='mid', width=0.12/2.0, scale=1.0/25.0 )    
...
#==================================================================================
    ...
    output_file_name = "%s%s%i.png" % ("result " + str(gas_index) + "/enlarged velocity left/",\
                                       "enlarged_velocity", quantity_of_files)
    plt.savefig(output_file_name)
    #plt.show()
    print 75+100/4*float(quantity_of_files)/end_quantity_of_files, "%"
